...
# Создание экземпляров подсистемы пользователей и регистрация пользователей
...
# Создание экземпляра подсистемы товаров и добавление товаров
product_subsystem = ProductSubsystem()
product_subsystem.add_product("Ноутбук", 1000, "Электроника")
product_subsystem.add_product("Мышка", 20, "Компьютерные аксессуары")
product_subsystem.add_product("Футболка", 30, "Одежда")
...
# Создание экземпляра подсистемы заказов и создание заказа
